...
namespace LookingGlass
{
    ...
    public class InputManager
    {
        ...
        private class KeyMap
        {
            ...
            /// </summary>
            public List<KeyCode> Keys { get; } = new List<KeyCode>();

            /// <summary>
            ///     Gets the extended keys in the map.
            /// </summary>
            public List<ExtendedKeyCode> ExtendedKeys { get; } = new List<ExtendedKeyCode>();
        ...
        private static readonly InputEmulationMode emulationMode = InputEmulationMode.Always;
        private static float timeSinceClassicCheck = -3f;
        ...
        private static bool CheckButtonState(HardwareButton button, ButtonState state)
        {
            ...
            if (SearchForClassic && classicJoyNumber < 1) DoClassicSearch();
        ...
        private static KeyMap GetKeyMap(HardwareButton button)
        {
            ...
            if (buttonKeyMap == null) buttonKeyMap = new Dictionary<HardwareButton, KeyMap>();
        ...
        private static void UpdateEmulationBindings()
        {
            ...
            if (emulationMode == InputEmulationMode.Always ||
                emulationMode == InputEmulationMode.EditorOnly && Application.isEditor)
            {
        ...
        public static bool GetAnyButton()
        {
            ...
            foreach (var button in allButtons)
                if (GetButton((HardwareButton)button))
                    return true;
        ...
        public static bool GetAnyButtonDown()
        {
            ...
            // Check for any button
            foreach (var button in allButtons)
                if (GetButtonDown((HardwareButton)button))
                    return true;
        ...
        /// </returns>
        public static bool GetButton(HardwareButton button)
        {
        ...
        /// </returns>
        public static bool GetButtonUp(HardwareButton button)
        {
        ...
        /// </remarks>
        public static bool SearchForClassic { get; set; } = true;
